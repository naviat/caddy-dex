...
[![Build Status](https://travis-ci.org/naviat/caddy-dex.svg?branch=master)](https://travis-ci.org/naviat/caddy-dex)
...
```bash
$ git clone https://github.com/naviat/caddy-dex.git
$ cd caddy-dex
```
...
Edit the [docker-compose](https://github.com/naviat/caddy-dex/blob/master/docker-compose.yml) 
...
services:
  caddy:
    ...
    image: naviat/caddy:${CADDY_VERSION:-0.10.9}
...
The caddy-dex is MIT licensed and the Caddy 
[source code](https://github.com/mholt/caddy/blob/master/LICENSE.txt) is Apache 2.0 licensed. 
Because naviat/caddy is built from source, it's not subject to the 
